...
public class ImageLoader {
	 ...
	 */
	public void displayImage(String uri, ImageAware imageAware, String auth) {
		displayImage(uri, imageAware, null, null, null, auth);
	}
	...
	public void displayImage(String uri, ImageAware imageAware,
			ImageLoadingListener listener, String auth) {
		displayImage(uri, imageAware, null, listener, null, auth);
	}
	 ...
	 */
	public void displayImage(String uri, ImageAware imageAware,
			DisplayImageOptions options, String auth) {
		displayImage(uri, imageAware, options, null, null, auth);
	}
	...
	public void displayImage(String uri, ImageAware imageAware,
			...
			String auth) {
		displayImage(uri, imageAware, options, listener, null, auth);
	}
	...
	public void displayImage(String uri, ImageAware imageAware,
			DisplayImageOptions options, ImageLoadingListener listener,
			ImageLoadingProgressListener progressListener, String auth) {
		checkConfiguration();
		if (imageAware == null) {
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			LoadAndDisplayImageTask displayTask = new LoadAndDisplayImageTask(
					engine, imageLoadingInfo, defineHandler(options), auth);
			if (options.isSyncLoading()) {
				displayTask.run();
			} else {
				engine.submit(displayTask);
	 ...
	 */
	public void displayImage(String uri, ImageView imageView, String auth) {
		displayImage(uri, new ImageViewAware(imageView), null, null, auth);
	}
	...
	public void displayImage(String uri, ImageView imageView,
			DisplayImageOptions options, String auth) {
		displayImage(uri, new ImageViewAware(imageView), options, null, auth);
	}
	...
	public void displayImage(String uri, ImageView imageView,
			DisplayImageOptions options, ImageLoadingListener listener,
			String auth) {
		displayImage(uri, imageView, options, listener, null, auth);
	}
	 ...
	 *             called before
	 */
	public void loadImage(String uri, ImageLoadingListener listener, String auth) {
		loadImage(uri, null, null, listener, null, auth);
	}
	...
	public void loadImage(String uri, ImageSize targetImageSize,
			ImageLoadingListener listener, String auth) {
		loadImage(uri, targetImageSize, null, listener, null, auth);
	}
	...
	public void loadImage(String uri, DisplayImageOptions options,
			ImageLoadingListener listener, String auth) {
		loadImage(uri, null, options, listener, null, auth);
	}
	...
	public void loadImage(String uri, ImageSize targetImageSize,
			DisplayImageOptions options, ImageLoadingListener listener,
			String auth) {
		loadImage(uri, targetImageSize, options, listener, null, auth);
	}
	...
	public void loadImage(String uri, ImageSize targetImageSize,
		...
		NonViewAware imageAware = new NonViewAware(uri, targetImageSize,
				ViewScaleType.CROP);
		displayImage(uri, imageAware, options, listener, progressListener, auth);
	}
	 ...
	 *             called before
	 */
	public Bitmap loadImageSync(String uri, String auth) {
		return loadImageSync(uri, null, null, auth);
	}
	...
	public Bitmap loadImageSync(String uri, DisplayImageOptions options,
			String auth) {
		return loadImageSync(uri, null, options, auth);
	}
	...
	public Bitmap loadImageSync(String uri, ImageSize targetImageSize,
			String auth) {
		return loadImageSync(uri, targetImageSize, null, auth);
	}
	...
	public Bitmap loadImageSync(String uri, ImageSize targetImageSize,
		...
		loadImage(uri, targetImageSize, options, listener, auth);
	...
	public Object getExtraForDownloader() {
		return configuration.defaultDisplayImageOptions.getExtraForDownloader();
	}
}
